...
function calcSlope(opts) {
  var shapeType = _$e.get(opts, 'shapeType');

  var dom = _$e.get(opts, 'dom');

  var arrowPosition = _$e.get(opts, 'arrowPosition', 0.5);

  var path = _$e.get(opts, 'path');
...
var MDS = /*#__PURE__*/function () {
  ...
  _createClass(MDS, [{
    ...
    value: function layout() {
      ...
      try {
        // square distances
        var M = Matrix.mul(Matrix.pow(distances, 2), -0.5); // double centre the rows/columns
